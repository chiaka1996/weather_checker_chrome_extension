...
___CSS_LOADER_EXPORT___.push([module.id, `body {
    ...
    color: white;
}`, "",{"version":3,"sources":["webpack://./src/options/options.css"],"names":[],"mappings":"AAAA;IACI,WAAW;IACX,oCAAoC;IACpC,YAAY;AAChB","sourcesContent":["body {\r\n    width: 100%;\r\n    background-color: rgb(247, 247, 247);\r\n    color: white;\r\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @mui/material */ "./node_modules/@mui/material/Switch/Switch.js");
...
/* harmony import */ var _options_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./options.css */ "./src/options/options.css");
...
const App = () => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        (0,_utils_storage__WEBPACK_IMPORTED_MODULE_6__.getStoredOptions)().then((options) => setOptions(options));
    }, []);
    ...
    const handleSaveButtonClick = () => {
        setFormState('saving');
        (0,_utils_storage__WEBPACK_IMPORTED_MODULE_6__.setStoredOptions)(options)
            .then(() => {
            setTimeout(() => {
                setFormState('ready');
            }, 1000);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_8__["default"], { mx: '10%', my: '2%' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_9__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_10__["default"], null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_11__["default"], { container: true, direction: "column", spacing: 2 },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_11__["default"], { item: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__["default"], { variant: "h4" }, "weather extension options")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_11__["default"], { item: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__["default"], { variant: "body1" }, "Home city name"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_13__["default"], { fullWidth: true, placeholder: 'enter a home city name', value: options.homeCity, onChange: event => handleHomeCityChange(event.target.value), disabled: isFieldsDisabled })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_11__["default"], { item: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__["default"], { variant: "body1" }, "Auto toggle overlay on webpage load"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_14__["default"], { color: "primary", checked: options.hasAutoOverlay, onChange: (event, checked) => handleAutoOverlayChange(checked), disabled: isFieldsDisabled })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_11__["default"], { item: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_15__["default"], { variant: "contained", color: "primary", onClick: handleSaveButtonClick, disabled: isFieldsDisabled }, formState === 'ready' ? "save" : "saving...")))))));
};
const root = document.createElement('div');
(0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(document.body.appendChild(root)).render(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(App, null));
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkweather_tracking_extension"] = self["webpackChunkweather_tracking_extension"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_mui_material_Box_Box_js-node_modules_mui_material_Button_Button_js-node_-6336db","vendors-node_modules_mui_material_Grid_Grid_js-node_modules_mui_material_Switch_Switch_js-nod-67d120"], () => (__webpack_require__("./src/options/options.tsx")))
